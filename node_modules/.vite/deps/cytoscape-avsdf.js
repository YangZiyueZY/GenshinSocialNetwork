...
// node_modules/avsdf-base/node_modules/layout-base/layout-base.js
var require_layout_base = __commonJS({
  "node_modules/avsdf-base/node_modules/layout-base/layout-base.js"(exports, module) {
...
var require_avsdf_base = __commonJS({
  "node_modules/avsdf-base/avsdf-base.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
...
var require_cytoscape_avsdf = __commonJS({
  "node_modules/cytoscape-avsdf/cytoscape-avsdf.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
        module.exports = factory(require_avsdf_base());
      else if (typeof define === "function" && define.amd)
        define(["avsdf-base"], factory);
      else if (typeof exports === "object")
        exports["cytoscapeAvsdf"] = factory(require_avsdf_base());
      else
        ...
        function(modules) {
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var AVSDF = function(_ContinuousLayout) {
              _inherits(AVSDF2, _ContinuousLayout);
              function AVSDF2(options) {
                _classCallCheck(this, AVSDF2);
                var _this = _possibleConstructorReturn(this, (AVSDF2.__proto__ || Object.getPrototypeOf(AVSDF2)).call(this, assign({}, defaults, options)));
                if (options.nodeSeparation != null) AVSDFConstants.DEFAULT_NODE_SEPARATION = options.nodeSeparation;
                else AVSDFConstants.DEFAULT_NODE_SEPARATION = defaults.nodeSeparation;
                return _this;
              }
              _createClass(AVSDF2, [{
                key: "prerun",
                ...
                value: function destroy() {
                  _get(AVSDF2.prototype.__proto__ || Object.getPrototypeOf(AVSDF2.prototype), "destroy", this).call(this);
                  return this;
                }
                /**
                ...
                value: function processChildrenList(parent, children, layout) {
                  ...
                  for (var i = 0; i < size; i++) {
                    ...
                    if (theChild.outerWidth() != null && theChild.outerHeight() != null) {
                      theNode = parent.add(new AVSDFNode(layout.graphManager, null, new PointD(theChild.position("x") - dimensions.w / 2, theChild.position("y") - dimensions.h / 2), new DimensionD2(parseFloat(dimensions.w), parseFloat(dimensions.h))));
                    } else {
...
export default require_cytoscape_avsdf();
//# sourceMappingURL=cytoscape-avsdf.js.map
